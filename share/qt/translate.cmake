...
function(extract_strings output)
  ...
  file(STRINGS "kpopcoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *kpopcoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"kpopcoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/kpopcoinstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/kpopcoinstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/kpopcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/kpopcoin_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/kpopcoin_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/kpopcoin_en.xlf" kpopcoin_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" kpopcoin_en "${kpopcoin_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" kpopcoin_en "${kpopcoin_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/kpopcoin_en.xlf" "${kpopcoin_en}")
