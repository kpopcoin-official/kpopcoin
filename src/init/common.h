...
//! @file
//! @brief Common init functions shared by kpopcoin-node, kpopcoin-wallet, etc.

#ifndef KPOPCOIN_INIT_COMMON_H
#define KPOPCOIN_INIT_COMMON_H
