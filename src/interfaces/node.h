...
#ifndef KPOPCOIN_INTERFACES_NODE_H
#define KPOPCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a kpopcoin node (kpopcoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or kpopcoin.conf.
...
#endif // KPOPCOIN_INTERFACES_NODE_H
