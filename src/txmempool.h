...
#ifndef KPOPCOIN_TXMEMPOOL_H
#define KPOPCOIN_TXMEMPOOL_H
 ...
 * Kpopcoin-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Kpopcoin-specific parts of mempool
