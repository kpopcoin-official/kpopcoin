...
#ifndef KPOPCOIN_CHAINPARAMSBASE_H
#define KPOPCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between kpopcoin-cli and kpopcoind)
 * of a given instance of the Kpopcoin system.
 */
...
#endif // KPOPCOIN_CHAINPARAMSBASE_H
