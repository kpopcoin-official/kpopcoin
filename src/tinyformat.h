...
#include <algorithm>
#include <attributes.h> // Added for Kpopcoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Kpopcoin Core
#include <util/string.h> // Added for Kpopcoin Core
...
// Added for Kpopcoin Core. Similar to std::runtime_format from C++26.
...
// Added for Kpopcoin Core. Wrapper for checking format strings at compile time.
