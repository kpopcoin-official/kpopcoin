...
#ifndef KPOPCOIN_COMMON_SIGNMESSAGE_H
#define KPOPCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's kpopcoin address, it must refer to a public key.
...
#endif // KPOPCOIN_COMMON_SIGNMESSAGE_H
