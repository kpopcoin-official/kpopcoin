 ...
 * for both kpopcoind and kpopcoin-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <kpopcoin-build-info.h>
// The <kpopcoin-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
//
#define GIT_COMMIT_ID "1d6ca9755da2397b14e273ece2624c7daac13e7d"
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/kpopcoin/bips/blob/master/bip-0014.mediawiki)
 */
