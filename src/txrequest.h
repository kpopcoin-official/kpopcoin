...
#ifndef KPOPCOIN_TXREQUEST_H
#define KPOPCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://kpopcoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
