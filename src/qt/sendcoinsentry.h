...
#ifndef KPOPCOIN_QT_SENDCOINSENTRY_H
#define KPOPCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending kpopcoins.
 */
...
#endif // KPOPCOIN_QT_SENDCOINSENTRY_H
