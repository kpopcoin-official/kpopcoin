...
#ifndef KPOPCOIN_QT_GUIUTIL_H
#define KPOPCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Kpopcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kpopcoin:" URI into recipient object, return true on successful parsing
