...
{
    // Test regression https://github.com/kpopcoin/kpopcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/kpopcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/kpopcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Kpopcoin/Kpopcoin-Qt.conf and all else left as default,
    // kpopcoin-qt should set both -listen and -listenonion to false and start successfully.
