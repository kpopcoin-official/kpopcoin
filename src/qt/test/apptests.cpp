...
//! Entry point for KpopcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &KpopcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for KpopcoinGUI tests.
void AppTests::guiTests(KpopcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &KpopcoinGUI::consoleShown, this, &AppTests::consoleTests);
