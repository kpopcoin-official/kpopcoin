...
#ifndef KPOPCOIN_QT_KPOPCOINGUI_H
#define KPOPCOIN_QT_KPOPCOINGUI_H
...
/**
  Kpopcoin GUI main class. This class represents the main window of the Kpopcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KpopcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KpopcoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~KpopcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kpopcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, KpopcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Kpopcoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(KpopcoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // KPOPCOIN_QT_KPOPCOINGUI_H
