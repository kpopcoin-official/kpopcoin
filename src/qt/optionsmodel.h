...
#ifndef KPOPCOIN_QT_OPTIONSMODEL_H
#define KPOPCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Kpopcoin client.
...
public:
    ...
    KpopcoinUnit getDisplayUnit() const { return m_display_kpopcoin_unit; }
...
private:
    ...
    QString language;
    KpopcoinUnit m_display_kpopcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(KpopcoinUnit unit);
...
#endif // KPOPCOIN_QT_OPTIONSMODEL_H
