...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = KpopcoinUnits::formatWithUnit(unit, amount, true, KpopcoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    KpopcoinUnit unit{KpopcoinUnit::BTC};
...
{
    KpopcoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(KpopcoinUnits::formatWithPrivacy(unit, balances.balance, KpopcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(KpopcoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, KpopcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(KpopcoinUnits::formatWithPrivacy(unit, balances.immature_balance, KpopcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(KpopcoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, KpopcoinUnits::SeparatorStyle::ALWAYS, m_privacy));
