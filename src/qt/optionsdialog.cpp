      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->kpopcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->kpopcoinAtStartup);
    ...
    ui->kpopcoinAtStartup->setToolTip(ui->kpopcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->kpopcoinAtStartup->setText(ui->kpopcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openKpopcoinConfButton->setToolTip(ui->openKpopcoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new KpopcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kpopcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKpopcoinConfButton_clicked()
{
