...
#ifndef KPOPCOIN_WALLET_WALLETUTIL_H
#define KPOPCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! kpopcoin from opening the wallet, thinking it was newly created, and
...
#endif // KPOPCOIN_WALLET_WALLETUTIL_H
