...
#ifndef KPOPCOIN_WALLET_WALLET_H
#define KPOPCOIN_WALLET_WALLET_H
...
public:
     ...
     * kpopcoin-wallet tool code or by wallet migration code. If this is called
...
#endif // KPOPCOIN_WALLET_WALLET_H
