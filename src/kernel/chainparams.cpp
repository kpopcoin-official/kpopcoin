...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        consensus.nSubsidyHalvingInterval = 4320; // 3 months(90 days)
    ...
    //    genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        // ==== 1. 제네시스 블록 생성 (현재 시간으로 업데이트 및 논스 초기화) ====
        const char* pszTimestamp = "10,000kp:doa, Reduction:15/16,Min reward: 1 kp.";
        genesis = CreateGenesisBlock(1782346429, 955621286, 0x1d00ffff, 1, 10000 * COIN);
      
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"000000007ab60f8f5e336869a9510c3285bd1d29d163ed7c2991a77f18631c66"});
        assert(genesis.hashMerkleRoot == uint256{"9ec80b983510751421cc0ed399c4699f4d043007940d7fbcec2de3178b961b54"});
        ...
        // release ASAP to avoid it where possible.
         vSeeds.emplace_back("112.146.112.60"); //dns ip
...
//        assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
        ...
        vSeeds.emplace_back("testnet-seed.kpopcoin.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtc.petertodd.net.");
        vSeeds.emplace_back("seed.testnet.kpopcoin.sprovoost.nl.");
...
//        assert(genesis.hashMerkleRoot == uint256{"7aa0a7ae1e223414cb807e40cd57e667b718e42aaf9306db9102fe28912b7b4e"});
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.kpopcoin.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.kpopcoin.sprovoost.nl.");
...
//        assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
        ...
        m_assumeutxo_data = {
            ...
            {
                // For use by test/functional/feature_assumeutxo.py and test/functional/tool_kpopcoin_chainstate.py
                .height = 299,
