    ...
    if (!CLIENT_VERSION_IS_RELEASE) {
        m_warnings.insert(
            {Warning::PRE_RELEASE_TEST_BUILD,
             _("This is a Kpopcoin pre-release test build. Use at your own risk. Adjustments are currently being made behind the scenes—thanks for taking a look early!")});
    }
}
