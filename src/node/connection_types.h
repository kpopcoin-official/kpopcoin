...
#ifndef KPOPCOIN_NODE_CONNECTION_TYPES_H
#define KPOPCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/kpopcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Kpopcoin’s Peer-to-Peer Network")
...
#endif // KPOPCOIN_NODE_CONNECTION_TYPES_H
