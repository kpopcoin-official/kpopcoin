...
#ifndef KPOPCOIN_RPC_PROTOCOL_H
#define KPOPCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in kpopcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Kpopcoin is not connected
