...
#ifndef KPOPCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define KPOPCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // KPOPCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
