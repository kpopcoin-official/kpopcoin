...
#ifndef KPOPCOIN_IPC_CAPNP_COMMON_TYPES_H
#define KPOPCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between kpopcoin processes.
...
//! Functions to serialize / deserialize common kpopcoin types.
namespace mp {
...
#endif // KPOPCOIN_IPC_CAPNP_COMMON_TYPES_H
