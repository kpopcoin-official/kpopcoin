...
extern thread_local ThreadContext g_thread_context; // NOLINT(kpopcoin-nontrivial-threadlocal)
// Silence nonstandard kpopcoin tidy error "Variable with non-trivial destructor
