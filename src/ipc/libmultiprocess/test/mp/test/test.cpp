...
{
    // Regression test for kpopcoin/kpopcoin#34711, kpopcoin/kpopcoin#34756 where a
...
{
    // Regression test for kpopcoin/kpopcoin#34777 heap-use-after-free where
...
{
    // Regression test for kpopcoin/kpopcoin#34782 stack-use-after-return where
