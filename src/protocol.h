...
#ifndef KPOPCOIN_PROTOCOL_H
#define KPOPCOIN_PROTOCOL_H
...
/**
 * Kpopcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Kpopcoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // kpopcoin-development mailing list. Remember that service bits are just
