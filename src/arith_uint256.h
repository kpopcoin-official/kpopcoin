...
#ifndef KPOPCOIN_ARITH_UINT256_H
#define KPOPCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Kpopcoin only uses this "compact" format for encoding difficulty
...
#endif // KPOPCOIN_ARITH_UINT256_H
