...
#ifndef KPOPCOIN_TEST_SCRIPTNUM10_H
#define KPOPCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kpopcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // KPOPCOIN_TEST_SCRIPTNUM10_H
