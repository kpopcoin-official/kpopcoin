...
{
    BOOST_CHECK(TestSplitHost("www.kpopcoincore.org", "www.kpopcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.kpopcoincore.org]", "www.kpopcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.kpopcoincore.org:80", "www.kpopcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kpopcoincore.org]:80", "www.kpopcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.kpopcoincore.org:65536", "www.kpopcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.kpopcoincore.org:0", "www.kpopcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.kpopcoincore.org:", "www.kpopcoincore.org:", 0, false));
}
