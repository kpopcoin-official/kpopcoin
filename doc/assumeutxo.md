...
Assumeutxo is a feature that allows fast bootstrapping of a validating kpopcoind
instance.
...
```
$ kpopcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ kpopcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
