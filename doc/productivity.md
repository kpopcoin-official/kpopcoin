...
```sh
cmake --build build --target kpopcoind kpopcoin-cli
cmake --build build --target kpopcoin-qt
cmake --build build --target bench_kpopcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:kpopcoin/kpopcoin.git
```
...
> e.g. github.com/kpopcoin/kpopcoin.git or for the GUI github.com/kpopcoin-core/gui
