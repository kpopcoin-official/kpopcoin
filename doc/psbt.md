# PSBT Howto for Kpopcoin Core

Since Kpopcoin Core 0.17, an RPC interface exists for Partially Signed Kpopcoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/kpopcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Kpopcoin transactions that are not fully signed
...
#### Multisig with multiple Kpopcoin Core instances
