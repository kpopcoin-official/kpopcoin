Kpopcoin Core version 0.10.4 is now available from:

  <https://kpopcoin.org/bin/kpopcoin-core-0.10.4/>
...
- #6953 `43c2789` Split kpopcoin-tx into its own package
- #6953 `dfe0d4d` Include kpopcoin-tx binary on Debian/Ubuntu
