...
Kpopcoin Core version 0.19.1 is now available from:

  <https://kpopcoincore.org/bin/kpopcoin-core-0.19.1/>
...
From Kpopcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Kpopcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Kpopcoin Core does not yet change appearance when
...
- #17488 fix "kpopcoind already running" warnings on macOS (fanquake)
