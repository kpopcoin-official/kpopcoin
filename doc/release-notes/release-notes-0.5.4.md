Kpopcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kpopcoin/files/Kpopcoin/kpopcoin-0.5.4/
...
http://gitorious.org/kpopcoin/kpopcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Kpopcoin-Qt notifications under Growl 1.3.
Increase required age of Kpopcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKpopcoin properly when installing Kpopcoin-Qt over it. (Windows)
