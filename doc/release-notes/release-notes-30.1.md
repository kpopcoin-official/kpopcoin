...
Kpopcoin Core version v30.1 is now available from:

  <https://kpopcoincore.org/bin/kpopcoin-core-30.1/>
...
- #33229 multiprocess: Don't require kpopcoin -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.kpopcoin.dashjr-list-of-p2p-nodes.us
