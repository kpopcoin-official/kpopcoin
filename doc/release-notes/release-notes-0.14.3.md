Kpopcoin Core version *0.14.3* is now available from:

  <https://kpopcoin.org/bin/kpopcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/kpopcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
