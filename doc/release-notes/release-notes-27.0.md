Kpopcoin Core version 27.0 is now available from:

  <https://kpopcoincore.org/bin/kpopcoin-core-27.0/>
...
libkpopcoinconsensus
-------------------

- libkpopcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libkpopcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Kpopcoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Kpopcoin Core would
