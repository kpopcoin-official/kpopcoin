Kpopcoin Core version 0.9.4 is now available from:

  https://kpopcoin.org/bin/0.9.4/
...
this update is incompatible with the Kpopcoin system and could lead to consensus
forks.

Kpopcoin Core released binaries from https://kpopcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kpopcoin/+archive/ubuntu/kpopcoin
- A third-party or self-compiled Kpopcoin Core

upgrade to Kpopcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
