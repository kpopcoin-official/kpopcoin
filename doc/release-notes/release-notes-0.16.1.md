Kpopcoin Core version 0.16.1 is now available from:

  <https://kpopcoincore.org/bin/kpopcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting kpopcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure kpopcoind processes are cleaned up when tests end (sdaftuar)
