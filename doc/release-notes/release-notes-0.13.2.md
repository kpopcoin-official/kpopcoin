Kpopcoin Core version 0.13.2 is now available from:

  <https://kpopcoin.org/bin/kpopcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update kpopcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kpopcoin-tx to create v2 transactions (btcdrak)
