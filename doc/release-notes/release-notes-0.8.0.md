Kpopcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kpopcoin/files/Kpopcoin/kpopcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Kpopcoin
...
New/changed settings (command-line or kpopcoin.conf file)
--------------------------------------------------------
