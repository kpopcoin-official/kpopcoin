...
declare -A LIBS
LIBS[cli]="libkpopcoin_cli.a"
LIBS[common]="libkpopcoin_common.a"
LIBS[consensus]="libkpopcoin_consensus.a"
LIBS[crypto]="libkpopcoin_crypto.a"
LIBS[node]="libkpopcoin_node.a"
LIBS[util]="libkpopcoin_util.a"
LIBS[wallet]="libkpopcoin_wallet.a"
...
# https://github.com/kpopcoin/kpopcoin/issues/10102
