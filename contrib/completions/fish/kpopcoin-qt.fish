...
complete --command kpopcoin-qt --no-files

# Extract options
function __fish_kpopcoinqt_get_options
...
complete \
    --command kpopcoin-qt \
    --arguments "(__fish_kpopcoinqt_get_options --nofiles)"
