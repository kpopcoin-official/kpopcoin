...
complete --command kpopcoind --no-files

# Extract options
function __fish_kpopcoind_get_options
...
complete \
    --command kpopcoind \
    --arguments "(__fish_kpopcoind_get_options --nofiles)"
