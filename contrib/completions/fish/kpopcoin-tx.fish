...
# Extract options
function __fish_kpopcoin_tx_get_options
...
# Extract commands
function __fish_kpopcoin_tx_get_commands
...
complete \
    --command kpopcoin-tx \
    --condition "not __fish_kpopcoin_seen_cmd (__fish_kpopcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_kpopcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command kpopcoin-tx \
    --arguments "(__fish_kpopcoin_tx_get_commands)" \
    --no-files
