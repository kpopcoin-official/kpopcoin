...
"""Example logging Kpopcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py <pid of kpopcoind>
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[kpopcoind_with_usdts])
