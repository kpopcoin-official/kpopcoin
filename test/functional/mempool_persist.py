...
By default, kpopcoind will dump mempool on shutdown and
...
class MempoolPersistTest(KpopcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent kpopcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
