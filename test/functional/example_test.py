...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KpopcoinTestFramework
    pass


class ExampleTest(KpopcoinTestFramework):
    # Each functional test is a subclass of the KpopcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        KpopcoinTestFramework class so other tests can use it."""
