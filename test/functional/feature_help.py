...
"""Verify that starting kpopcoin with -h works as expected."""

from test_framework.test_framework import KpopcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KpopcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kpopcoin with -h for help text")
        ...
        self.log.info("Start kpopcoin with -version for version information")
        ...
        self.log.info("Start kpopcoind with -fakearg to make sure it does not start")
