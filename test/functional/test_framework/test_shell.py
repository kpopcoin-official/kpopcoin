...
class TestShell:
    """Wrapper Class for KpopcoinTestFramework.

    The TestShell class extends the KpopcoinTestFramework
    ...
    class __TestShell(KpopcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by KpopcoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # KpopcoinTestFramework instances are supposed to be constructed with the path
