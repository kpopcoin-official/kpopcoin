...
Verify that a kpopcoind node can use an external signer command.
...
class RPCSignerTest(KpopcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart kpopcoind with -signer=<cmd>',
