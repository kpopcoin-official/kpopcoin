...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The kpopcoind node closes feeler connections as soon as a version
...
class P2PAddConnections(KpopcoinTestFramework):
    ...
    def run_test(self):
        ...
        # kpopcoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that kpopcoind sends its own version prior to processing
