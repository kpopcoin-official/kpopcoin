...
maintained:
* for `src/crc32c`: https://github.com/kpopcoin-core/crc32c-subtree.git (branch kpopcoin-fork)
* for `src/crypto/ctaes`: https://github.com/kpopcoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/kpopcoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/kpopcoin-core/leveldb-subtree.git (branch kpopcoin-fork)
* for `src/minisketch`: https://github.com/kpopcoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/kpopcoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/kpopcoin-core/secp256k1.git
```
